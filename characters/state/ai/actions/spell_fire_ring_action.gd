...
static func precondition() -> ai_planner.knowledge:
	...
	return ai_planner.knowledge.new(spell.self_pain() + spell.self_pain_per_second() * spell.duration(), -(spell.self_focus() + spell.self_focus_per_second() * spell.duration()), 0, 0, ai_planner.knowledge_mask.enemy_in_sight)
...
static func precondition_mask() -> int:
	return ai_planner.knowledge_mask.focus | ai_planner.knowledge_mask.focus_toggle | ai_planner.knowledge_mask.pain | ai_planner.knowledge_mask.pain_toggle | ai_planner.knowledge_mask.enemy_in_sight
